...
In the previous block of code, in the isValidName function, "/^\w+ \w+$/" will
also match numbers. The fix is in the following code, to only include alphabetic
characters in names.
...
function isValidName(name) {
  return (/^[a-z]+ [a-z]+$/i).test(name); // this line of code was omitted
}
