...
/* The issue is that the `toString` function used a deprecated getYear() method.
It needs to be updated to the getFullYear() method. Also, single digit days and
months need to be padded with zeroes.
