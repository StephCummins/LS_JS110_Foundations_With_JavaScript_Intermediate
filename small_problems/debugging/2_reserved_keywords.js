...
with some test cases, but we aren't seeing the expected result. 
...
/* In the original solution, forEach will always return undefined, so the line
to return true is never reached (it's ignored). For this reason, the original
